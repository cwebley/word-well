...
export function renderFamiliarityGate({
  headword,
  partOfSpeech,
  pronunciation,
  revision = false,
  ...
  return html`<section
    class="familiarity-gate"
    aria-labelledby="familiarity-heading"
  >
    ${renderWordHero({
      headword,
      pronunciation,
    ...
    <div class="region wrapper flow familiarity-prompt region-space:space-xl">
      ...
      <p class="familiarity-copy">
        ${revision
          ? "This updates your reference point without adding new learning evidence."
          : "Your answer sets the starting point for practice. It is not a test."}
      </p>
      <div class="familiarity-actions">
        ${choices
          .map((choice) =>
            renderButton({
              label: choice,
