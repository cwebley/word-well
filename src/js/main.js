...
function render() {
  ...
  if (route === "practice") {
    ...
    main.innerHTML = familiarity ? `<section class="card flow"><p class="lesson-label">History</p><h1 class="card-title">Words you've met</h1><p><strong>${lesson.headword}</strong> · ${familiarity}</p></section>` : renderStatus({ label: "History", detail: "Your word history will gather here after today's lesson." });
    ...
    main.innerHTML = renderFamiliarityGate({ revision: revising });
  } else {
