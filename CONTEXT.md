...
meaning. It stays valid while that meaning's definition and part of speech are
unchanged, so redrafting the lesson body does not discard the bank. Practice
...
**Lesson body**:
The learner-facing content of a Word lesson apart from its Practice items: the
...
**Usage note**:
An attested extension of a published meaning's core idea, in the same part of
speech, recorded beside that meaning rather than published as a meaning of its
own.
_Avoid_: Sense note, secondary sense

**Word family**:
The forms one documented derivation step from the headword that a learner is
shown alongside it. Membership follows a recorded relation, never a shared
